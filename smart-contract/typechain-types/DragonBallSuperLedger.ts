...
export interface dbsLedgerInterface extends utils.Interface {
  ...
  functions: {
    ...
    "withdrawMintFee()": FunctionFragment;
  };
...
export interface DragonBallSuperLedger extends BaseContract {
  contractName: "DragonBallSuperLedger";
  ...
  callStatic: {
    ...
    withdrawMintFee(overrides?: CallOverrides): Promise<void>;
  };
